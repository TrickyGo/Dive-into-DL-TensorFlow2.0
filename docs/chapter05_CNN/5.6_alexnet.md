...
```
    ...
    128/128 [==============================] - 3s 22ms/sample - loss: 2.3027 - accuracy: 0.1250
    




    <tensorflow.python.keras.callbacks.History at 0x2472fd1a508>
...
```
    ...
    2000/2000 [==============================] - 6s 3ms/sample - loss: 0.4943 - accuracy: 0.8215
    




    <tensorflow.python.keras.callbacks.History at 0x24756969908>
