...
* 3\. 深度学习基础
   ...
   * [3.2 线性回归的从零开始实现](https://github.com/TrickyGo/Dive-into-DL-TensorFlow2.0/blob/master/Documents%20(for%20reading)/ch3_DL_basics/3.2_linear-regression-scratch.md)
   ...
   * [3.7 softmax回归的简洁实现](https://github.com/TrickyGo/Dive-into-DL-TensorFlow2.0/blob/master/Documents%20(for%20reading)/ch3_DL_basics/3.7_softmax-regression-tensorflow2.0.md)
